...
public class CampManagementApplication {
        ...
        for (Student student : studentStore) {
          ...
          System.out.println(
              "아이디 : " + student.getStudentId() + " | 이름 : " + student.getStudentName() + " | 과목 : "
                  + subjectList + " | 상태 : " + student.getStudentStatus());
        }
        break;
      case 2:
        sc.nextLine();
        ...
        studentStore.stream()
            ...
            .forEach(student -> {
              ...
              System.out.println(
                  "아이디 : " + student.getStudentId() + " | 이름 : " + student.getStudentName()
                      + " | 과목 : " + String.join(", ", subjectNames) + " | 상태 : "
  ...
  private static void displayScoreView() {
    ...
    while (flag) {
      ...
      System.out.println("4. 과목별 평균 등급 조회");
      ...
      switch (input) {
        ...
        case 4 -> CheckAverageGradeBySubject();
  ...
  private static void inquireRoundGradeBySubject() {
    ...
    for (Score s : scoreStore) {
      if (Objects.equals(student.getStudentId(), s.getStudent().getStudentId()) && Objects.equals(
